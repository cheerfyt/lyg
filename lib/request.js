...
const exports = moudle.exports = req;

/**!
 * inherbits from http.IncomingMessage
 */
setProto(req, httpProto);


req.get = req.header = function header(name) {
  if (!name) throw new LygError("name is required");
  if (typeof name !== "string") throw new LygError("name must be string");
